public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Both _queue and _queue.RemoveAt were set to 1 so it threw an error
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: I set both _queue and _queue.RemoveAt to 0 so it went backwards
